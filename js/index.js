...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Comiendo tacos", "Preparando la cocina", "Juntando a los compas", "Obteniendo IPS :V", "Bajando sources", "Compilando web", "Obteniendo money", "I love linux", "Alabando a Efran", "Brincando muros", "Generando codigo", "Mejorando apariencia", "Generando apis", "Completando scripts", "Terminando con my bestfriend", "Preparando el momo"]);
