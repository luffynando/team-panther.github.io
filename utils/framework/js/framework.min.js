        ...
        a.DEFAULT = {
            ...
            function e() {
                o.options.navbarSmall || (o.options.navbarSmall = t(".navbar-redhawk").hasClass("navbar-small")), t('[data-toggle="tooltip"]').tooltip({
                    ...
                    o.inputsActive(this)
                }), t("input, textarea").filter("[autofocus]:eq(0)").focus(), o.initAjaxForm(), t(".redhawk-accordion, .panel-group").find(".collapse").on("shown.bs.collapse", function() {
            ...
            if ("undefined" != typeof t.fn.owlCarousel) {
                ...
                }), t(".redhawk-carousel").each(function() {
                    var e = "redhawk-carousel-" + a++,
                        o = t(this).attr("data-autoplay"),
                ...
                }), t(".redhawk-slider").each(function() {
                    var e = "redhawk-carousel-" + a++,
                        o = t(this).attr("data-autoplay");
                    t(this).addClass("owl-carousel").owlCarousel({
                        loop: !0,
            ...
            this.options.parallax && !this.isMobile && ("undefined" != typeof skrollr && "undefined" == typeof this.skrollr && (this.skrollr = skrollr.init({
                smoothScrolling: !1,
                forceHeight: !1
            })), "undefined" != typeof t.fn.jarallax && (t(".redhawk-banner-parallax:not(.banner-top) .image").each(function() {
                var a = parseFloat(t(this).attr("data-speed"));
                t(this).jarallax({
                    speed: isNaN(a) ? .4 : a
                })
            }), t(".redhawk-banner-parallax.banner-top").each(function() {
            ...
            }), t(".redhawk-footer-parallax").each(function() {
                ...
                a.each(function() {
                    var a = t(this),
                        n = {
                            ...
                            template: a.attr("data-twitter-template") || ["<div>", '    <div class="redhawk-twitter-icon"><i class="fa fa-twitter"></i></div>', '    <div class="redhawk-twitter-date date">', "        <span>{{date}}</span>", "    </div>", '    <div class="redhawk-twitter-text">', "       {{tweet}}", "    </div>", "</div>"].join(" "),
                            loadingText: "Loading...",
                            failText: "Failed to load data",
            ...
            a > this.navbarMaxTop && !this.navbarSmall && (this.navbarSmall = !0, t(".navbar-redhawk").addClass("navbar-small")), a <= this.navbarMaxTop && this.navbarSmall && (this.navbarSmall = !1, t(".navbar-redhawk").removeClass("navbar-small"))
        }, a.prototype.navbarCollapse = function() {
            var a = this;
            a.$document.on("click", ".navbar-redhawk [data-toggle=off-canvas]", function() {
                var a = t(".navbar-redhawk").find(t(this).attr("data-target")),
                    e = a.hasClass("collapse");
                a[(e ? "remove" : "add") + "Class"]("collapse"), t(".navbar-redhawk")[(e ? "add" : "remove") + "Class"]("redhawk-navbar-collapsed")
            });
            var e;
            a.$window.on("resize", function() {
                t(".navbar-redhawk").addClass("no-transition"), clearTimeout(e), e = setTimeout(function() {
                    t(".navbar-redhawk").removeClass("no-transition")
                }, 50)
            }), a.$document.on("click", ".redhawk-navbar-collapsed ~ .content-wrap", function() {
                t(".navbar-redhawk").find("[data-toggle=off-canvas]").click()
            }), a.options.fadeBetweenPages && t(".page-preloader").length || a.$document.on("click", ".navbar-redhawk .dropdown-toggle", function() {
            ...
            t(".navbar-redhawk").on("click", ".dropdown-menu .dropdown-toggle", function(a) {
                t(this).parent(".dropdown").toggleClass("open"), a.preventDefault(), a.stopPropagation()
            })
        }, a.prototype.initAjaxForm = function() {
            this.$document.on("submit", ".redhawk-form-ajax", function(a) {
                a.preventDefault();
                var e = t(this),
            ...
            "undefined" !== t.fn.hexagonProgress && t(".redhawk-hexagon-rating:not(.redhawk-hexagon-rating-ready)").each(function() {
                ...
                }), t(this).addClass("redhawk-hexagon-rating-ready")
            })
        }, window.redhawk = new a(a.DEFAULT)
    }(jQuery), a["true"] = t
}({}, function() {
    return this
}());